...
def open_file(): 
    ...
    file2 = open('Encrypted/'+file_name+'.txt',mode='w+', encoding="utf-8")
...
def file_three():
    ...
    myLabel4 = Label(third_frame,text="Pragya Sankhla",bg="light goldenrod")
    myLabel5 = Label(third_frame,text="Fatema Bohra",bg="light goldenrod")
